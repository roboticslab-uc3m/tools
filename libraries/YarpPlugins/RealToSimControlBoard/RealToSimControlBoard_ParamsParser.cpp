...
// Generated on: Sun May  3 12:18:00 2026
...
bool RealToSimControlBoard_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="modePosVel")
    {
        paramValue = std::to_string(m_modePosVel);
        return true;
    }
    if (paramName =="remotes")
    {
        return false;
    }
    if (paramName =="remotePrefix")
    {
        paramValue = m_remotePrefix;
        return true;
    }
    if (paramName =="remoteSuffix")
    {
        paramValue = m_remoteSuffix;
        return true;
    }
    if (paramName =="localSuffix")
    {
        paramValue = m_localSuffix;
        return true;
    }
...
std::string RealToSimControlBoard_ParamsParser::getConfiguration() const
{
