...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Additional software tools.")
set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_SOURCE_DIR}/README.md")
set(CPACK_PACKAGE_CONTACT "Roboticslab team at UC3M")

# Package version.
set(CPACK_PACKAGE_VERSION_MAJOR "${ROBOTICSLAB_TOOLS_VERSION_MAJOR}")
set(CPACK_PACKAGE_VERSION_MINOR "${ROBOTICSLAB_TOOLS_VERSION_MINOR}")
set(CPACK_PACKAGE_VERSION_PATCH "${ROBOTICSLAB_TOOLS_VERSION_PATCH}")
...
cpack_add_component(control_board_state_to_i_position
                    DISPLAY_NAME "Example program"
                    DESCRIPTION "Executable of example program."
                    GROUP applications
                    INSTALL_TYPES full)
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "roboticslab-tools_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/roboticslab-tools/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "roboticslab-tools-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()
